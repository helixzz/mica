...
<p align="center">
  <a href="https://github.com/helixzz/mica/releases/tag/v1.39.0"><img src="https://img.shields.io/badge/version-1.39.0-8B5E3C?style=flat-square" alt="Version" /></a>
...
- **询价表 Excel 导出**：从 PR 一键生成可发给供应商的填写模板（v1.34+）
- **采购订单（PO）**：审批通过后一键生成，自动带入 PR 标题便于识别
- **PR→PO 履约偏离追踪**：单个 PR 行可被多个 PO 履约，4 种履约类型（等价/降配/替换/补充派生），支持跨供应商配套采购（v1.26 – v1.33）
...
- **资源活动日志**：所有业务角色都可查看自己可见资源的完整事件时间线（v1.35+）
...
| v1.21 – v1.25 | ✅ | 行级权限加固 · PR 详情组织字段 · IT 采购员权限补齐 |
| v1.26 – v1.28 | ✅ | PR→PO 履约偏离追踪三部曲（schema + 后端 + 前端 + 治理） |
| v1.29 – v1.33 | ✅ | 三 Tab 转换向导 · POItem CRUD · 拆分可自定义价格/供应商 · SKU 现场创建 · 全前后端权限对齐 |
| v1.34 | ✅ | PR 询价表 Excel 导出 · Dashboard 信息对 it_buyer 全开 · 可收起侧边栏 |
| **v1.35** | ✅ | **资源活动日志对所有角色开放 · admin 可见所有 pending 审批** |
