...
- **License**：Apache 2.0
- **状态**：v0.7.3（2026-04-22）· [CHANGELOG.md](./CHANGELOG.md) · [Release](https://github.com/helixzz/mica/releases/tag/v0.7.3)
- **设计准则**：效率优先 > 扩展性 > 标准化管控
...
详见 [CHANGELOG.md](./CHANGELOG.md) "版本路线（规划中）" 章节。当前 v0.7.3 已交付；v0.8 候选主题：
- 飞书集成（消息通知 + 审批卡片联动）
